...
export const Hero = () => {
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img src={heroImage} alt="LED Strip Installation" className="w-full h-full object-cover opacity-50" />
      ...
      <div className="absolute inset-0 z-10">
        ...
        <div className="absolute top-2/3 right-0 w-full h-1 bg-gradient-led opacity-40 animate-led-flow" style={{
        animationDelay: '1s'
      }}></div>
      </div>
      ...
      <div className="absolute top-40 right-32 w-3 h-3 rounded-full bg-led-purple animate-glow-pulse" style={{
      animationDelay: '0.5s'
    }}></div>
      <div className="absolute bottom-32 left-40 w-2 h-2 rounded-full bg-led-green animate-glow-pulse" style={{
      animationDelay: '1.5s'
    }}></div>
      <div className="absolute bottom-20 right-20 w-3 h-3 rounded-full bg-led-pink animate-glow-pulse" style={{
      animationDelay: '2s'
    }}></div>
    </section>;
};